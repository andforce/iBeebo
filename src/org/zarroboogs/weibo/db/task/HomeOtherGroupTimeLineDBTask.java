    ...
    private static void reduceHomeOtherGroupTable(String accountId, String groupId) {
        ...
        if (needDeletedNumber > 0) {
            ...
            String sql = " delete from " + HomeOtherGroupTable.HomeOtherGroupDataTable.TABLE_NAME + " where "
                    ...
                    + " in " + "( select " + HomeOtherGroupTable.HomeOtherGroupDataTable.ID + " from "
                    + HomeOtherGroupTable.HomeOtherGroupDataTable.TABLE_NAME
                    + " where " + HomeOtherGroupTable.HomeOtherGroupDataTable.ACCOUNTID + " in " + "(" + accountId + ") "
                    + " and "
                    + HomeOtherGroupTable.HomeOtherGroupDataTable.GROUPID + " = " + groupId + " order by "
                    + HomeOtherGroupTable.HomeOtherGroupDataTable.ID
        ...
        if (c.moveToNext()) {
            try {
                ...
                getWsd().update(HomeOtherGroupTable.TABLE_NAME, cv,
                        HomeOtherGroupTable.ACCOUNTID + "=? AND " + HomeOtherGroupTable.GROUPID + " =? ", args);
