...
public class DraftDBManager {
    ...
    public List<DraftListViewItemBean> getDraftList(String accountId) {
        ...
        String sql = "select * from " + DraftTable.TABLE_NAME + " where " + DraftTable.ACCOUNTID + "  = " + accountId
        ...
        while (c.moveToNext()) {
            ...
            switch (type) {
                ...
                case DraftTable.TYPE_REPOST:
                    ...
                    MessageBean messageBean = gson.fromJson(c.getString(c.getColumnIndex(DraftTable.JSONDATA)),
                            MessageBean.class);
                ...
                case DraftTable.TYPE_COMMENT:
                    ...
                    MessageBean commentMessageBean = gson.fromJson(c.getString(c.getColumnIndex(DraftTable.JSONDATA)),
                            MessageBean.class);
                ...
                case DraftTable.TYPE_REPLY:
                    ...
                    CommentBean commentBean = gson.fromJson(c.getString(c.getColumnIndex(DraftTable.JSONDATA)),
                            CommentBean.class);
