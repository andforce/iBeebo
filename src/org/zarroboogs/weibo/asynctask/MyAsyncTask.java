...
public abstract class MyAsyncTask<Params, Progress, Result> {
	...
	private static final Executor CANCEL_OPERATION__THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(4, 4, KEEP_ALIVE, TimeUnit.SECONDS,
	 ...
	 * tasks in parallel.
	 */
	private static final Executor IO_THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(4, 10, KEEP_ALIVE, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(20),
			sIoThreadFactory, new ThreadPoolExecutor.DiscardOldestPolicy());

	public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(8, 10, KEEP_ALIVE, TimeUnit.SECONDS, new LinkedBlockingDeque<Runnable>(128) {
	...
	private static final Executor WAIT_DOWNLOAD_THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(4, 4, KEEP_ALIVE, TimeUnit.SECONDS,
