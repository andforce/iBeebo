...
public interface IWeiboClientListener {
    ...
    /**
     * Called when a Weibo responds to a dialog with an error. Executed by the thread that initiated
     * the dialog.
     */
    public void onWeiboException(WeiboException e);

    /**
     * Called when a dialog is canceled by the user. Executed by the thread that initiated the
     * dialog.
     */
