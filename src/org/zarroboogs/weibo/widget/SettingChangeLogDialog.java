 ...
 */
public class SettingChangeLogDialog {
    static final private String TAG = "ChangeLogDialog";

    static final private String TITLE_CHANGELOG = "title_changelog";
    static final private String CHANGELOG_XML = "setting_changelog";

    private Activity fActivity;

    public SettingChangeLogDialog(Activity context) {
        fActivity = context;
    }
    ...
    private String GetStyle() {
        return "<style type=\"text/css\">" + "h1 { margin-left: 0px; font-size: 12pt; }"
