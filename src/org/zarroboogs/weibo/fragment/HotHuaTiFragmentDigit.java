...
public class HotHuaTiFragmentDigit extends BaseStateFragment {
...
//            }
    ...
    public void loadNewRepostData() {	
    	pullToRefreshListView.setRefreshing();
        	...
        	mAsyncHttoClient.get(WeiBoURLs.hotHuatiDigit("4u8Kc2373x4U9rFAXPfxc7SC21d", mPage), new AsyncHttpResponseHandler() {
