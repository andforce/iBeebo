...
public class HotWeiboFragmentZuiYou extends AbsBaseTimeLineFragment<MessageListBean> {
...
//            }
    ...
    public void loadNewRepostData() {		
    	getPullToRefreshListView().setRefreshing();
        	...
        	mAsyncHttoClient.get(WeiBoURLs.hotWeiboZuiyou("4u8Kc2373x4U9rFAXPfxc7SC21d", mPage), new AsyncHttpResponseHandler() {
