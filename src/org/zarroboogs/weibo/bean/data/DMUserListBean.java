 ...
 */
public class DMUserListBean extends DataListItem<DMUserBean, DMUserListBean> implements Parcelable {
    ...
    public static final Parcelable.Creator<DMUserListBean> CREATOR = new Parcelable.Creator<DMUserListBean>() {
