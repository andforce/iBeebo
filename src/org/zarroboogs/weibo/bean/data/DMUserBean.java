 ...
 */
public class DMUserBean extends DataItem implements Parcelable {
    ...
    public static final Parcelable.Creator<DMUserBean> CREATOR = new Parcelable.Creator<DMUserBean>() {
