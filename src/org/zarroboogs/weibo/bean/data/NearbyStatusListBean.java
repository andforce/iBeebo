 ...
 */
public class NearbyStatusListBean extends DataListItem<MessageBean, NearbyStatusListBean> implements Parcelable {
    ...
    public static final Parcelable.Creator<NearbyStatusListBean> CREATOR = new Parcelable.Creator<NearbyStatusListBean>() {
