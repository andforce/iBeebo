...
public class WeibaTree implements java.io.Serializable {
	...
	/*
	 * "code": "1", "text": "热门", "data": [ { "text": "iPhone 6 Plus", "code":
	 * "5yiHuw" }, { "text": "iPhone 6", "code": "3o33sO" }, { "text":
	 * "iPhone 5s", "code": "3G5oUM" }, { "text": "iPad客户端", "code": "4ACxed" },
	 * { "text": "魅族MX4", "code": "503Oti" }, { "text": "索尼Z3", "code": "1JALDw"
	 * }, { "text": "三星GALAXY Note 4", "code": "584Wm0" }, { "text":
