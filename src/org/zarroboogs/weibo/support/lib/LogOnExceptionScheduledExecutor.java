...
/**
 * User: qii Date: 14-7-26 ScheduledThreadPoolExecutor will stop when exception occur, and it wont
 * notify us, it stop silently here we catch exception, write to log, then stop
 */
