...
/**
 * User: qii Date: 13-9-29 issue: #150 android:actionModeShareDrawalbe is not a
 * public attribute, and ShareActionProvider don't have any method to modify
 * icon too. so must override ShareActionProvider, find the first ImageView, set
 * resource, this is just a workaround, a better solution is to write custom
 * ActionProvider
 */
