...
import org.zarroboogs.weibo.bean.*;
...
public class ObjectToStringUtility {
	...
	public static String toString(MessageReCmtCountBean bean) {
		return "message id=" + bean.getId() + "," + "reposts=" + bean.getReposts() + "," + "comments=" + bean.getComments();
	}
	...
	public static String toString(UnreadBean bean) {
		return "unread count: mention comments=" + bean.getMention_cmt() + "," + "mention weibos=" + bean.getMention_status() + "," + "comments"
				+ bean.getCmt();
	}
	...
	public static String toString(UserBean bean) {
		return "user id=" + bean.getId() + "," + "name=" + bean.getScreen_name();
	}
}
