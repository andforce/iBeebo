...
public class MentionsTimeLinePagerAdapter extends AppFragmentPagerAdapter {
    ...
    public MentionsTimeLinePagerAdapter(MentionsTimeLineFragment fragment, ViewPager viewPager, FragmentManager fm,
            SparseArray<Fragment> fragmentList) {
        super(fm);
        this.fragmentList = fragmentList;
        fragmentList.append(MentionsTimeLineFragment.MENTIONS_WEIBO_CHILD_POSITION,
                fragment.getMentionsWeiboTimeLineFragment());
        fragmentList.append(MentionsTimeLineFragment.MENTIONS_COMMENT_CHILD_POSITION,
        ...
        if (!fragmentList.get(MentionsTimeLineFragment.MENTIONS_WEIBO_CHILD_POSITION).isAdded())
            transaction.add(viewPager.getId(), fragmentList.get(MentionsTimeLineFragment.MENTIONS_WEIBO_CHILD_POSITION),
    ...
    protected String getTag(int position) {
        ...
        tagList.append(MentionsTimeLineFragment.MENTIONS_COMMENT_CHILD_POSITION,
                MentionsCommentTimeLineFragment.class.getName());
