...
//                getPullToRefreshListView().setRefreshing();
    ...
    private BroadcastReceiver newBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            final AccountBean intentAccount = intent.getParcelableExtra(BundleArgsConstants.ACCOUNT_EXTRA);
            ...
            CommentListBean data = intent.getParcelableExtra(BundleArgsConstants.COMMENTS_TO_ME_EXTRA);
    ...
    private void clearUnreadComment(final UnreadBean data) {
        new MyAsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    new ClearUnreadDao(token).clearCommentUnread(data, BeeboApplication.getInstance().getAccountBean().getUid());
