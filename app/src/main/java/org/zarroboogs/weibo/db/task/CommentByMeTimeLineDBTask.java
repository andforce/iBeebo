...
public class CommentByMeTimeLineDBTask {
    ...
    private static void reduceCommentTable(String accountId) {
        String searchCount = "select count(" + CommentByMeTable.CommentByMeDataTable.ID + ") as total" + " from "
                ...
                + CommentByMeTable.CommentByMeDataTable.ACCOUNTID + " = " + accountId;
        int total = 0;
        ...
        // CommentByMeTable.CommentByMeDataTable.HOME_DATA_TABLE + " where " +
    ...
    private void replaceCommentLineMsg(CommentListBean list, String accountId) {
        ...
        // CommentByMeTable.CommentByMeDataTable.HOME_DATA_TABLE);
    ...
    static void deleteAllComments(String accountId) {
        String sql = "delete from " + CommentByMeTable.CommentByMeDataTable.TABLE_NAME + " where "
                + CommentByMeTable.CommentByMeDataTable.ACCOUNTID + " in "
                + "(" + accountId + ")";
