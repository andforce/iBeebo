...
public class CommentListBean extends DataListItem<CommentBean, CommentListBean> implements Parcelable {
    ...
    public void addNewData(CommentListBean newValue) {
        ...
        boolean receivedCountBelowRequestCount = newValue.getSize() < Integer.valueOf(SettingUtils.getMsgCount());
        boolean receivedCountEqualRequestCount = newValue.getSize() == Integer.valueOf(SettingUtils.getMsgCount());
